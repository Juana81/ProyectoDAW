...
<html>
<head>
<title> Pagina reset Contraseña </title>
...
<div class="container-all">
	...
	<div class="ctn-form">
		...
		<h1 class="title">Reset Contraseña?</h1>
				<div class="widget-shadow">
					<div class="login-top">
						<h4>Rsetea tu contraseñas </h4>
					</div>
    ...
    echo $msg;
							...
							<input type="password" name="confirmpassword" class="lock" placeholder="Confirma Contraseña" required="true">
							
							<input type="submit" name="submit" value="Reset">
							<div class="forgot-grid">
								
								<div class="forgot">
									<a href="index.php">Ya tengo una cuenta como administrador</a>
								</div>
