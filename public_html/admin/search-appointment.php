...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Buscar por Nombre o Número  de Telefono</label> <input id="searchdata" type="text" name="searchdata" required="true" class="form-control">
...
$cnt=$cnt+1;
  ...
  <tr>
    <td colspan="8"> No hay ninguna cita con la palabra clave</td>
